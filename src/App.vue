    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-heading text-uppercase">Hi! My name is Sandra</div>
          <div class="intro-lead-in">And I'm a Junior Fullstack Web-Developer</div>
          <a
